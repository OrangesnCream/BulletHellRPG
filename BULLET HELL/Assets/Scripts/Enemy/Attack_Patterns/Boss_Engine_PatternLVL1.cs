...
public class Boss_Engine_PatterLVL1 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!added1)//health patterns || boss specific attacks || change hitbox for 2.5d look
        {
            ...
            patternMove.Add(moveCommand.Movement); patternShoot1.Add(Shoot1Command.doNothing);                 patternShoot2.Add(shoot2Command.doNothing);                 patternLaser1.Add(laser1Command.doNothing);     patternLaserAim.Add(laserAimCommand.SwingCounter);  patternBarrel.Add(barrelCommand.doNothing); patternSpawner.Add(spawnerCommand.doNothing);
        ...
        else if (!added2 && halfpattern && healthBar.getHealth() <= healthBar.getMaxHealth() / 2)
        {
            ...
            patternMove.Add(moveCommand.Dash);      patternShoot1.Add(Shoot1Command.SpinOpposite);              patternShoot2.Add(shoot2Command.doNothing);                 patternLaser1.Add(laser1Command.Shoot);         patternLaserAim.Add(laserAimCommand.doNothing);     patternBarrel.Add(barrelCommand.doNothing); patternSpawner.Add(spawnerCommand.doNothing);
            ...
            patternMove.Add(moveCommand.Dash);      patternShoot1.Add(Shoot1Command.SpinOpposite);              patternShoot2.Add(shoot2Command.Spin);                      patternLaser1.Add(laser1Command.doNothing);     patternLaserAim.Add(laserAimCommand.doNothing);     patternBarrel.Add(barrelCommand.doNothing); patternSpawner.Add(spawnerCommand.doNothing);
            ...
            patternMove.Add(moveCommand.Dash);      patternShoot1.Add(Shoot1Command.BulletSlowerSpinOpposite);  patternShoot2.Add(shoot2Command.doNothing);                 patternLaser1.Add(laser1Command.doNothing);     patternLaserAim.Add(laserAimCommand.SwingCounter);  patternBarrel.Add(barrelCommand.doNothing); patternSpawner.Add(spawnerCommand.doNothing);
